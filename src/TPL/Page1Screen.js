...
import btn_icon_back_page1 from './images/btn_icon_back_page1.png';
    ...
    return (
      <Container fluid={true} className="AppScreen Page1Screen" style={baseStyle}>
        ...
        <div className="layoutFlow" style={layoutFlowStyle}>
          ...
          <div className='actionFont elButton' style={style_button_outer}>
            <Button style={style_button}  color="accent" onClick={this.onClick_elButton} >
              {this.props.locStrings.screen22_button_227290}
            </Button>
        ...
        <Appbar className="navBar">
          <div className="title">page.1</div>  <div className="backBtn" onClick={ (ev)=>{ this.props.appActions.goBack() } }><img src={btn_icon_back_page1} alt="" style={{width: '50%'}} /></div>
        </Appbar>
