...
// import CoverPhoto from '../../TPL2-2/images/CoverPhoto.jpg';
import b1 from '../../TPL2-2/images/b1.jpg';
...
import ThemeNPC from '../../TPL2-2/ThemeNPC';
        ...
        <Card className={classes.card}>
         <CardContent align="center">
          ...
          className={classes.form}
            align="center"
            control={<Checkbox color="secondary"  value="yes" onChange={this.handleCheck('5')}/>}
            label="可愛風"
          />
