...
import StartScreen from '../Sticker/StartScreen.js';
import DataSheet_localizationSheet from '../Sticker/DataSheet_localizationSheet.js';
import DataSheet_addText from '../Sticker/DataSheet_addText.js';
import DataSheet_addSticker from '../Sticker/DataSheet_addSticker.js';
...
export default class App extends Component {
  constructor(props) {
    ...
    this.dataSheets['addText'] = new DataSheet_addText('addText', this.dataSheetDidUpdate);
    this.dataSheets['addSticker'] = new DataSheet_addSticker('addSticker', this.dataSheetDidUpdate);
